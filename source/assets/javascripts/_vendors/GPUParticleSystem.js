...
THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = THREE.ImageUtils.loadTexture("assets/images/textures/perlin-512.png");
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = THREE.ImageUtils.loadTexture("assets/images/textures/particle2.png");
